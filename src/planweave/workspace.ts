...
export function planweaveDataRoot(): string {
 ...
 * 落到默认的 `~/.planweave`。
 */
export function ensurePlanweaveHome(): string {
 ...
 */
export async function openOrCreateProject(name: string): Promise<InitWorkspaceResult> {
  ensurePlanweaveHome()
