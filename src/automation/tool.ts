...
import { CodedError, normalizeModelRef, type CronJob, type JobType } from './types.js'
...
export function registerAutomationTool({ ctx, store, suggestions, isAutoApprove }: AutomationToolDeps): () => void {
