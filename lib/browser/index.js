...
import { CdpConnection, createPageSession, navigateAndWait, navigateHistory, waitForPageReady, captureScreenshot, setViewport, fetchBrowserWsUrl, evaluateJson, dispatchKey, } from './cdp.js';
                ...
                try {
                    ...
                    if (webGuiOrigin !== '') {
                        try {
                            ...
                            if (String(e?.message || '').includes('递归套娃'))
                                throw e;
