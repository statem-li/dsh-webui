...
export declare const WEBUI_MODULE_KEYS: readonly ["messageWidth", "doneSound", "donePill", "approvalNotify", "ctrlEnter", "continueBtn", "sessionMotion", "sessionPin", "rewind", "screenshot", "promptOptimize", "zhThinking", "peakValley", "chatStats", "toolSummary", "reasoningSync", "modelSeats", "providerHub", "vision", "webSearch", "mail", "skills", "browser", "automation", "planweave", "memory", "usage", "fileExplorer", "dirPicker", "tmpCleaner", "appearance", "sidebarFloat", "updater", "proxy"];
/** 单个功能模块的 key。 */
