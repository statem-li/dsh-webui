...
export declare const AUTOMATION_SCHEMA_VERSION = 1;
/** 调度类型。 */
...
/** updateJob 允许修改的字段子集。 */
export type UpdateJobPatch = Partial<Pick<CronJob, 'label' | 'model' | 'schedule' | 'prompt' | 'enabled' | 'type'>>;
...
export declare function normalizeModelRef(model: unknown): ModelRef;
/** job 归一化：补默认值、规范 model、钳制 every 最小间隔。 */
export declare function normalizeJob(job: CronJob): CronJob;
/** every 类型的最小间隔（毫秒）。 */
export declare const MIN_EVERY_INTERVAL_MS = 60000;
/** 从 label / prompt 推导显示名。 */
export declare function deriveJobLabel({ label, prompt }: {
    label?: string;
    prompt?: string;
}): string;
