 ...
 * 直接复用同步的 codeToHtml。
 */
export async function renderMarkdownToHtml(md, theme) {
...
const THEME_VARS = {
    light: '--bg:#ffffff;--fg:#24292f;--fg2:#57606a;--fg3:#9aa0a6;--border:#d0d7de;' +
        '--border2:#eaecef;--accent:#4176e6;--code-bg:#f6f8fa;--inline-code:#c7254e;' +
        '--quote-bg:#f6f8fa;--thead-bg:#f6f8fa;--zebra:#fafbfc',
    dark: '--bg:#0d1117;--fg:#e6edf3;--fg2:#8b949e;--fg3:#6e7681;--border:#30363d;' +
...
export function buildThemeCss(theme, pageWidth, pageHeight) {
