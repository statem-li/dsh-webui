...
function resolveConfig(input) {
    ...
    const numbers = ['extractEveryTurns', 'compileEveryTurns', 'compileThreshold', 'decayLambda', 'hitBonus', 'injectTokenBudget', 'injectRefreshSteps', 'extractMaxChars', 'minImportance'];
