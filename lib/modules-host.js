...
import { WEBUI_MODULE_KEYS, normalizeModules, } from './modules.js';
/** settings.yaml 命名空间。 */
...
const MODULES_SCHEMA = z.object(Object.fromEntries(WEBUI_MODULE_KEYS.map((key) => [key, z.boolean().default(true)])));
 ...
 */
export function applyModulesHost(ctx) {
    let scope;
    try {
...
//# sourceMappingURL=modules-host.js.map